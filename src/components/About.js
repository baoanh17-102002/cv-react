...
import Image from '../assets/img/baoanh2.jpg';

const About = () => {
  return <section className='section relative lg:before:content-pattern lg:before:absolute lg:before:top-[332px] lg:before:left-[180px] lg:after:content-rope' id='about'>
