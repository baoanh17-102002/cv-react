...
const Contributors = () => {
  return <section className='section' id='contributors'>
    <div className="container mx-auto">
      <h2 className='section-title'>{contributors.title} <span className='dot'></span></h2>
      ...
      <div className='flex flex-col gap-10 items-center lg:flex-row lg:gap-20 lg:flex-wrap lg:justify-center lg:px-[204px]'>
        {contributors.brands.map((brands, index)=>
        {
          return <div className='max-w-[260px] h-24 flex items-center'>
