...
const Services = () => {
  return <section className='selection' id='skills'>
    <div className="container mx-auto">
      ...
      <div className='flex flex-col items-center gap-y-12 lg:flex-row lg:justify-between lg:px-[136px]'>
        {services.skills.map((services, index)=> {
          return <div className='p-[30px] w-full max-w-[417px] flex flex-col text-center lg:text-left hover:bg-white hover:shadow-2xl cursor-crosshair transition-all'>
            ...
            <p className='text-grey text-lg lg:mb-16'>{services.description}</p>
          </div>
        })}
      </div>
    </div>
